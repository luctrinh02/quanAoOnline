				...
				<tbody>
					<c:forEach items="${list}" var="obj">
						<tr class="align-middle">
							...
							<td><a
								href="/PH17307_TrinhTienLuc_Asignment_SOF3011/admin/bills/more?id=${obj.id }"
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												...
												<a
													href="/PH17307_TrinhTienLuc_Asignment_SOF3011/admin/bills/CancelIndex?idBill=${obj.id }"
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" class="btn btn-secondary"
													data-bs-dismiss="modal">Huỷ</button>
												<a
													href="/PH17307_TrinhTienLuc_Asignment_SOF3011/admin/bills/SuccessIndex?idBill=${obj.id }"
