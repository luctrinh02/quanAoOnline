...
<div class="d-flex flex-wrap justify-content-center mt-5 mb-5">
	<a href="/PH17307_TrinhTienLuc_Asignment_SOF3011/phuKien?tag=0" ${tag==0?'hidden':'' } class="btn btn-primary m-2" >Tất cả</a>
	<a href="/PH17307_TrinhTienLuc_Asignment_SOF3011/phuKien?tag=1" ${tag==1?'hidden':'' } class="btn btn-primary m-2">Sale</a>
	<a href="/PH17307_TrinhTienLuc_Asignment_SOF3011/phuKien?tag=2" ${tag==2?'hidden':'' } class="btn btn-primary m-2">New</a>
	<a href="/PH17307_TrinhTienLuc_Asignment_SOF3011/phuKien?tag=3" ${tag==3?'hidden':'' } class="btn btn-primary m-2">Hot</a>
</div>
