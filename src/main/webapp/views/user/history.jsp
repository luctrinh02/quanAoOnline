		...
		<tbody>
			<c:forEach items="${list}" var="obj">
				<tr class="align-middle">
					<td>
						<fmt:formatDate value="${obj.date }" pattern="dd/MM/yyyy"/>
					</td>
					<td>
						<fmt:formatNumber pattern="###,###,###">${obj.totalMoney }</fmt:formatNumber> VNĐ
					</td>
					<td><c:choose>
					...
					<td><a
						href="/PH17307_TrinhTienLuc_Asignment_SOF3011/user/bill?id=${obj.id }"
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a
											href="/PH17307_TrinhTienLuc_Asignment_SOF3011/user/cancel?id=${obj.id }"
